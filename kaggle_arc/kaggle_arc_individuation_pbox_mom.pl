...
:- abolish(add_top_bot/6).
:- abolish(add_top_bot_left_right/10).
:- abolish(at_least_two_colors/2).
:- abolish(black_and/2).
:- abolish(color_mass_points_to_sizes/2).
:- abolish(dif_fg/2).
:- abolish(edge_or_center/3).
:- abolish(edit_grid_col/5).
:- abolish(edit_grid_row/4).
:- abolish(existingObject/2).
:- abolish(experiment/1).
:- abolish(factor_of/2).
:- abolish(find_gridline_color/2).
:- abolish(find_halfline_color/3).
:- abolish(find_rowline_color/2).
:- abolish(flatten_set_bf/2).
:- abolish(foundbox_why/2).
:- abolish(gather_sizes/3).
:- abolish(good_borders/4).
:- abolish(grid_halves/4).
:- abolish(hollow_out/7).
:- abolish(i_pbox/2).
:- abolish(i_pbox_l/10).
:- abolish(is_all_same/2).
:- abolish(is_bg_color_or_var/1).
:- abolish(is_fg_color_or_var/1).
:- abolish(is_odd/1).
:- abolish(is_real_color_or_wfg/1).
:- abolish(list_to_set_bf/2).
:- abolish(make_gclip_cache/0).
:- abolish(make_gclip_cache_0/0).
:- abolish(make_gclip_cache_file/0).
:- abolish(make_search_box/8).
:- abolish(make_search_box_fresh/5).
:- abolish(make_search_box_fresh_w_borders/8).
:- abolish(make_search_box_m1/8).
:- abolish(make_squarish/3).
:- abolish(mapgrid_hv/3).
:- abolish(maplist_ls/2).
:- abolish(maybe_pbox_vm/1).
:- abolish(maybe_subdiv/2).
:- abolish(maybe_swap/4).
:- abolish(member1/2).
:- abolish(member_e/2).
:- abolish(member_eq/2).
:- abolish(member_ls/2).
:- abolish(near_size/4).
:- abolish(near_size1/3).
:- abolish(need_pboxes/1).
:- abolish(no_rule/2).
:- abolish(not_all_same/2).
:- abolish(not_edge/2).
:- abolish(not_in_eq/2).
:- abolish(not_irow/2).
:- abolish(not_whole_row_or_col/2).
:- abolish(nsew_edges_trimed/2).
:- abolish(obj_global_grid/2).
:- abolish(obj_size2D/2).
:- abolish(pbox/0).
:- abolish(pbox/1).
:- abolish(pbox_indivs/0).
:- abolish(pbox_io/4).
:- abolish(pbox_io_result/5).
:- abolish(pbox_pair/4).
:- abolish(pbox_phase_check/2).
:- abolish(pbox_vm/1).
:- abolish(pbox_vm/5).
:- abolish(pbox_vm_special_sizes/1).
:- abolish(pbox_vm_special_sizes/2).
:- abolish(pbox_vm_special_sizes/3).
:- abolish(pbox_vm_special_sizes/7).
:- abolish(pbox_vm_special_sizes_list/2).
:- abolish(recolor_into/3).
:- abolish(repaint_area/7).
:- abolish(repaint_this/9).
:- abolish(rim_of/2).
:- abolish(shoot_lines_on_black_grid/2).
:- abolish(shoot_lines_on_colored_row/4).
:- abolish(shoot_lines_on_rows/4).
:- abolish(test_pbox/0).
:- abolish(this_grid_is_multiple_of_other/1).
:- abolish(trim_ends/2).
:- abolish(trim_lends/2).
:- abolish(trim_rends/2).
:- abolish(vis2D_and_1x1_larger/3).
:- abolish(which_partof_square/10).
:- abolish(whole_row_or_col/2).
%:- abolish(with_debugging/2).
:- abolish(within1of/2).
