...
show_individuated_pair_cont2(_PairName,_ROptions,_GridIn,_GridOut,_InC,_OutC):-
   (nb_current(menu_key,'i');nb_current(menu_key,'j');nb_current(menu_key,'o')),!.
...
((((((
 ...
 if_t( once(true; \+ nb_current(menu_key,'j')),
