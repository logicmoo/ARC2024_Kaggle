...
rhs(out0_black0_3_4_4_4,rot90,sid_1x2,cxy(4,4),txy(4,4),black). 
rhs(out0_black0_7_9_8_9,rot90,sid_1x2,cxy(8,9),txy(8,9),black). 
rhs(out0_red8_8_2_10_4,sameR,sid_hollow_3x3,cxy(9,3),txy(9,3),red). 
rhs(out0_blue10_2_3_5_5,sameR,sid_hollow_3x3,cxy(4,4),txy(4,4),blue). 
rhs(out0_blue10_6_8_9_10,sameR,sid_hollow_3x3,cxy(8,9),txy(8,9),blue). 
rhs(out0_black0_9_3_9_3,sameR,sid_1x1,cxy(9,3),txy(9,3),black). 
rhs(out0_black0_1_1_10_10,sameR,s5771107,cxy(5,5),txy(10,10),black). 
...
rhs(out1_red8_7_2_10_4,flipV,sid_tetris_Z_270_Rotated_2x3,cxy(9,3),txy(7,2),red). 
rhs(out1_blue9_2_3_6_5,sameR,s14864972,cxy(4,4),txy(4,4),blue). 
rhs(out1_blue9_4_7_8_9,sameR,s14864972,cxy(6,8),txy(6,8),blue). 
rhs(out1_black0_1_1_10_10,sameR,s2597892,cxy(5,6),txy(10,1),black). 
...
```prolog
rhs(out0_red7_2_2_4_5,rot270,s84645,cxy(3,4),txy(2,2),red). 
rhs(out0_blue9_4_7_7_10,rot270,s2885155,cxy(5,9),txy(5,9),blue). 
rhs(out0_blue9_7_2_10_5,rot270,s2885155,cxy(8,4),txy(8,4),blue). 
rhs(out0_black0_1_1_10_10,sameR,s2157333,cxy(5,6),txy(10,1),black). 
```
