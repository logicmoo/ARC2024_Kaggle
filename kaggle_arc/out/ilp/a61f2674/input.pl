...
:-end_bg. 
:-begin_in_pos. 
pos(rhs(trn_0,center2D(9,8),rot90,red,hv(rotSize2D(grav),3,1),vis2D(1,3),3,sid_13)). 
pos(rhs(trn_0,center2D(3,6),rot90,blue,hv(rotSize2D(grav),8,1),vis2D(1,8),8,s16658777)). 
pos(rhs(trn_1,center2D(3,9),rot90,red,hv(rotSize2D(grav),2,1),vis2D(1,2),2,sid_12)). 
pos(rhs(trn_1,center2D(5,5),rot90,blue,hv(rotSize2D(grav),9,1),vis2D(1,9),9,s13578114)). 
pos(rhs(trn_1,center2D(2,5),sameR,black,hv(rotSize2D(grav),4,9),vis2D(4,9),34,s2245337)). 
pos(rhs(trn_1,center2D(8,5),sameR,black,hv(rotSize2D(grav),4,9),vis2D(4,9),36,s2245337)). 
pos(rhs(tst_0,center2D(8,6),rot90,blue,hv(rotSize2D(grav),8,1),vis2D(1,8),8,s16658777)). 
pos(rhs(tst_0,center2D(2,9),sameR,red,hv(rotSize2D(grav),1,1),vis2D(1,1),1,sid_11)). 
:-end_in_pos. 
