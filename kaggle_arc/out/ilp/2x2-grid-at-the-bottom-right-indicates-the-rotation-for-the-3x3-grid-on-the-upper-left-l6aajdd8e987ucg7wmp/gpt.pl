...
Riddle t(2x2-grid-at-the-bottom-right-indicates-the-rotation-for-the-3x3-grid-on-the-upper-left-l6aajdd8e987ucg7wmp)
...
Title: t(2x2-grid-at-the-bottom-right-indicates-the-rotation-for-the-3x3-grid-on-the-upper-left-l6aajdd8e987ucg7wmp)
...
rhs(out0_green2_1_1_2_1,sameR,sid_2x1,cxy(2,1),txy(2,1),green). 
rhs(out0_green1_3_3_3_3,sameR,sid_1x1,cxy(3,3),txy(3,3),green). 
rhs(out0_black0_1_1_5_5,sameR,s663654,cxy(3,3),txy(3,3),black). 
...
rhs(out1_green4_1_1_2_3,rot270,sid_t180_3x2,cxy(1,2),txy(1,2),green). 
rhs(out1_black0_1_1_5_5,sameR,s7660163,cxy(3,3),txy(3,3),black). 
...
rhs(out2_green3_1_1_3_2,flipD,sid_tetris_Triple_East_and_North_2x2,cxy(2,2),txy(1,1),green). 
rhs(out2_black0_1_1_5_5,sameR,s11778174,cxy(3,3),txy(3,3),black). 
...
```prolog
rhs(out0_green4_1_1_2_3,rot90,sid_tetris_Z_270_Rotated_2x3,cxy(2,2),txy(1,1),green). 
rhs(out0_black0_1_1_5_5,sameR,s11470631,cxy(3,3),txy(3,3),black). 
```
