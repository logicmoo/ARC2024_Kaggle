...
rhs(out0_black0_1_1_23_13,rot90,s9642428,cxy(12,8),txy(12,8),black). 
...
rhs(out1_black0_1_1_30_14,rot90,s186023,cxy(15,7),txy(30,14),black). 
...
rhs(out2_black0_1_1_30_16,rot90,s3735665,cxy(16,9),txy(1,1),black). 
...
```prolog
rhs(out0_black0_13_9_16_10,rot90,s4868024,cxy(15,9),txy(14,10),black). 
...
rhs(out0_black0_1_1_30_17,rot90,s12520586,cxy(16,9),txy(16,9),black). 
```
