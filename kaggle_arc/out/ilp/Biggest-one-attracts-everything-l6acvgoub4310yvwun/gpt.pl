...
Riddle t(Biggest-one-attracts-everything-l6acvgoub4310yvwun)
...
Title: t(Biggest-one-attracts-everything-l6acvgoub4310yvwun)
...
rhs(out0_silver2_3_2_3_3,rot90,sid_2x1,cxy(3,3),txy(3,3),silver). 
rhs(out0_cyan4_1_2_2_3,sameR,sid_1x1,cxy(2,3),txy(1,2),cyan). 
rhs(out0_orange1_2_4_2_4,sameR,sid_1x1,cxy(2,4),txy(2,4),orange). 
rhs(out0_black0_1_1_5_5,sameR,s21581,cxy(3,3),txy(3,3),black). 
...
rhs(out1_purple2_5_2_5_3,rot90,sid_2x1,cxy(5,3),txy(5,3),purple). 
rhs(out1_orange3_3_1_5_1,sameR,sid_2x1,cxy(4,1),txy(4,1),orange). 
rhs(out1_cyan1_2_1_2_1,sameR,sid_1x1,cxy(2,1),txy(2,1),cyan). 
rhs(out1_yellow1_3_2_3_2,sameR,sid_1x1,cxy(3,2),txy(3,2),yellow). 
rhs(out1_black0_1_1_5_5,sameR,s6872181,cxy(3,4),txy(1,1),black). 
...
rhs(out2_orange3_2_2_4_2,sameR,sid_2x1,cxy(3,2),txy(3,2),orange). 
rhs(out2_brown6_2_3_4_4,sameR,sid_2x1,cxy(3,4),txy(3,4),brown). 
rhs(out2_purple1_5_4_5_4,sameR,sid_1x1,cxy(5,4),txy(5,4),purple). 
rhs(out2_black0_1_1_5_5,sameR,s14136912,cxy(3,3),txy(3,3),black). 
...
```prolog
rhs(out0_silver2_2_2_3_2,sameR,sid_2x1,cxy(3,2),txy(3,2),silver). 
rhs(out0_cyan5_1_1_1_5,rot90,sid_2x1,cxy(1,3),txy(1,3),cyan). 
rhs(out0_brown1_2_4_2_4,sameR,sid_1x1,cxy(2,4),txy(2,4),brown). 
rhs(out0_yellow1_2_5_2_5,sameR,sid_1x1,cxy(2,5),txy(2,5),yellow). 
rhs(out0_black0_2_1_5_5,sameR,s111272,cxy(4,3),txy(2,1),black). 
```
