...
%  Objects of Test 1 for input grid (1,1)-(13,13)
lhs(in2_green3_3_10_4_11,rot180,sid_tetris_Z_270_Rotated_2x3,cxy(3,10),txy(3,10),green,no_child).
lhs(in2_blue3_7_7_8_8,rot270,sid_tetris_Z_270_Rotated_2x3,cxy(7,8),txy(7,8),blue,no_child).
lhs(in2_cyan3_11_3_12_4,rot90,sid_tetris_Z_270_Rotated_2x3,cxy(12,3),txy(12,3),cyan,no_child).
lhs(in2_purple3_3_3_4_4,sameR,sid_tetris_Z_270_Rotated_2x3,cxy(4,4),txy(4,4),purple,no_child).
lhs(in2_black0_1_1_13_13,sameR,s11261021,cxy(7,7),txy(7,7),black,no_child).


Explain the transformation rules and then show the resulting object/8 of Exam 1 in a codeblock
```prolog

%  Objects of Test 1 for output grid (1,1)-(4,4)
```

Grade your response from:
```prolog
rhs(out2_green3_1_1_2_2,rot180,sid_tetris_Z_270_Rotated_2x3,cxy(1,1),txy(1,1),green).
rhs(out2_blue3_1_3_2_4,rot270,sid_tetris_Z_270_Rotated_2x3,cxy(1,4),txy(1,4),blue).
rhs(out2_cyan3_3_1_4_2,rot90,sid_tetris_Z_270_Rotated_2x3,cxy(4,1),txy(4,1),cyan).
rhs(out2_purple3_3_3_4_4,sameR,sid_tetris_Z_270_Rotated_2x3,cxy(4,4),txy(4,4),purple).
rhs(out2_black0_2_2_3_3,sameR,sid_1x1,cxy(3,3),txy(2,2),black).
```
