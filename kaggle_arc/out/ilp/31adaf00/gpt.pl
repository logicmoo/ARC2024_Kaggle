...
rhs(out0_silver2_1_9_1_10,rot90,sid_2x1,cxy(1,10),txy(1,10)). 
rhs(out0_silver2_1_1_2_1,sameR,sid_2x1,cxy(2,1),txy(2,1)). 
rhs(out0_silver2_1_3_2_3,sameR,sid_2x1,cxy(2,3),txy(2,3)). 
rhs(out0_blue4_7_6_8_7,sameR,sid_1x1,cxy(8,7),txy(7,6)). 
rhs(out0_silver3_9_2_10_3,rot180,sid_tetris_Z_270_Rotated_2x3,cxy(9,2),txy(9,2)). 
rhs(out0_silver3_3_2_4_3,rot90,sid_tetris_Z_270_Rotated_2x3,cxy(4,2),txy(4,2)). 
rhs(out0_silver4_9_5_10_7,flipDHV,sid_tetris_Triple_East_and_North_2x2,cxy(10,6),txy(9,5)). 
rhs(out0_silver3_6_9_8_10,flipD,sid_tetris_Triple_East_and_North_2x2,cxy(7,10),txy(6,9)). 
rhs(out0_silver5_7_8_10_9,sameR,sid_tetris_Triple_East_and_North_2x2,cxy(9,8),txy(10,9)). 
rhs(out0_blue9_3_8_5_10,sameR,sid_1x1,cxy(4,9),txy(4,9)). 
rhs(out0_blue9_5_1_7_3,sameR,sid_1x1,cxy(6,2),txy(6,2)). 
rhs(out0_silver5_1_6_3_8,rot180,s11869152,cxy(2,7),txy(1,6)). 
rhs(out0_silver7_5_4_8_6,rot180,s9374370,cxy(6,5),txy(8,4)). 
rhs(out0_silver1_2_5_2_5,sameR,sid_1x1,cxy(2,5),txy(2,5)). 
rhs(out0_silver1_4_5_4_5,sameR,sid_1x1,cxy(4,5),txy(4,5)). 
rhs(out0_silver1_5_7_5_7,sameR,sid_1x1,cxy(5,7),txy(5,7)). 
rhs(out0_silver1_8_1_8_1,sameR,sid_1x1,cxy(8,1),txy(8,1)). 
rhs(out0_silver1_10_4_10_4,sameR,sid_1x1,cxy(10,4),txy(10,4)). 
...
rhs(out1_blue4_1_7_2_8,sameR,sid_1x1,cxy(2,8),txy(1,7)). 
rhs(out1_silver2_8_9_9_10,rot90,sid_tetris_Triple_East_and_North_2x2,cxy(9,10),txy(9,10)). 
rhs(out1_silver2_9_6_10_7,rot90,sid_tetris_Triple_East_and_North_2x2,cxy(10,7),txy(10,7)). 
rhs(out1_silver3_3_8_4_9,rot270,sid_tetris_Z_270_Rotated_2x3,cxy(3,9),txy(3,9)). 
rhs(out1_silver3_1_1_2_2,sameR,sid_tetris_Z_270_Rotated_2x3,cxy(2,2),txy(2,2)). 
rhs(out1_black0_1_5_2_6,sameR,sid_tetris_Z_270_Rotated_2x3,cxy(1,6),txy(1,6)). 
rhs(out1_black0_1_1_2_2,sameR,sid_1x1,cxy(2,2),txy(1,1)). 
rhs(out1_black0_1_3_2_4,sameR,sid_1x1,cxy(2,4),txy(1,3)). 
rhs(out1_black0_3_1_4_2,sameR,sid_1x1,cxy(4,2),txy(3,1)). 
rhs(out1_black0_4_5_5_6,sameR,sid_1x1,cxy(5,6),txy(4,5)). 
rhs(out1_black0_7_4_8_5,sameR,sid_1x1,cxy(8,5),txy(7,4)). 
rhs(out1_silver4_4_3_6_4,sameR,sid_tetris_Triple_East_and_North_2x2,cxy(5,4),txy(4,3)). 
rhs(out1_silver3_5_1_7_2,flipD,sid_tetris_Triple_East_and_North_2x2,cxy(6,2),txy(5,1)). 
rhs(out1_blue6_1_3_3_5,rot180,s12760807,cxy(2,4),txy(1,3)). 
rhs(out1_silver6_8_2_10_5,rot180,sid_plus_3x3,cxy(9,3),txy(9,3)). 
rhs(out1_silver10_5_6_8_9,rot90,s3516597,cxy(7,7),txy(7,7)). 
rhs(out1_silver5_1_4_4_7,sameR,s3071927,cxy(3,6),txy(3,6)). 
rhs(out1_black0_5_1_10_3,rot90,s15312845,cxy(7,2),txy(10,1)). 
rhs(out1_black0_1_4_10_10,rot90,s4206902,cxy(6,8),txy(10,4)). 
rhs(out1_blue35_3_1_10_9,flipDHV,s647584,cxy(6,5),txy(3,1)). 
rhs(out1_black0_1_1_1_1,sameR,sid_1x1,cxy(1,1),txy(1,1)). 
rhs(out1_silver1_1_9_1_9,sameR,sid_1x1,cxy(1,9),txy(1,9)). 
...
rhs(out1_black0_5_7_5_7,sameR,sid_1x1,cxy(5,7),txy(5,7)). 
rhs(out1_black0_6_5_6_5,sameR,sid_1x1,cxy(6,5),txy(6,5)). 
...
rhs(out2_silver2_10_1_10_2,rot90,sid_2x1,cxy(10,2),txy(10,2)). 
rhs(out2_silver2_2_5_3_5,sameR,sid_2x1,cxy(3,5),txy(3,5)). 
rhs(out2_black0_7_10_8_10,rot90,sid_1x2,cxy(8,10),txy(8,10)). 
rhs(out2_blue4_1_3_2_4,sameR,sid_1x1,cxy(2,4),txy(1,3)). 
rhs(out2_blue4_4_1_5_2,sameR,sid_1x1,cxy(5,2),txy(4,1)). 
rhs(out2_blue4_9_6_10_7,sameR,sid_1x1,cxy(10,7),txy(9,6)). 
rhs(out2_silver3_5_2_6_4,flipH,sid_tetris_Triple_East_and_North_2x2,cxy(5,3),txy(6,2)). 
rhs(out2_silver3_2_1_3_3,sameR,sid_tetris_Triple_East_and_North_2x2,cxy(3,2),txy(3,2)). 
rhs(out2_blue9_1_8_3_10,sameR,sid_1x1,cxy(2,9),txy(2,9)). 
rhs(out2_blue9_7_2_9_4,sameR,sid_1x1,cxy(8,3),txy(8,3)). 
rhs(out2_silver7_6_5_8_7,rot270,sid_u_3x2,cxy(7,6),txy(7,6)). 
rhs(out2_silver7_1_6_4_8,flipV,s12482970,cxy(3,7),txy(1,6)). 
rhs(out2_silver9_5_8_10_10,flipD,s15553490,cxy(8,9),txy(6,10)). 
rhs(out2_silver1_8_1_8_1,sameR,sid_1x1,cxy(8,1),txy(8,1)). 
rhs(out2_silver1_10_5_10_5,sameR,sid_1x1,cxy(10,5),txy(10,5)). 
...
```prolog
rhs(out0_silver2_5_5_6_5,sameR,sid_2x1,cxy(6,5),txy(6,5)). 
rhs(out0_black0_8_8_9_8,rot90,sid_1x2,cxy(9,8),txy(9,8)). 
rhs(out0_black0_4_8_4_9,sameR,sid_1x2,cxy(4,9),txy(4,9)). 
rhs(out0_blue4_2_1_3_2,sameR,sid_1x1,cxy(3,2),txy(2,1)). 
rhs(out0_blue4_6_3_7_4,sameR,sid_1x1,cxy(7,4),txy(6,3)). 
rhs(out0_blue4_9_6_10_7,sameR,sid_1x1,cxy(10,7),txy(9,6)). 
rhs(out0_silver3_8_3_9_4,rot180,sid_tetris_Z_270_Rotated_2x3,cxy(8,3),txy(8,3)). 
rhs(out0_silver3_4_2_5_3,rot270,sid_tetris_Z_270_Rotated_2x3,cxy(4,3),txy(4,3)). 
rhs(out0_silver3_6_1_7_2,sameR,sid_tetris_Z_270_Rotated_2x3,cxy(7,2),txy(7,2)). 
rhs(out0_silver5_7_6_8_8,flipDHV,sid_tetris_Z_270_Rotated_2x3,cxy(7,7),txy(8,6)). 
rhs(out0_silver4_8_8_10_9,sameR,sid_tetris_Z_270_Rotated_2x3,cxy(9,9),txy(10,8)). 
rhs(out0_black0_1_9_3_10,rot90,sid_tetris_Z_270_Rotated_2x3,cxy(2,10),txy(1,9)). 
rhs(out0_black0_1_6_2_8,sameR,s13770256,cxy(2,7),txy(1,6)). 
rhs(out0_silver5_2_7_4_9,rot90,s11385418,cxy(3,8),txy(3,8)). 
rhs(out0_silver5_4_8_6_10,sameR,sid_t180_3x2,cxy(5,9),txy(5,9)). 
rhs(out0_silver6_1_1_2_5,rot270,sid_t180_3x2,cxy(1,3),txy(1,3)). 
rhs(out0_black0_6_8_10_10,rot90,s10925715,cxy(8,9),txy(8,9)). 
rhs(out0_blue13_2_4_6_7,rot180,s12561063,cxy(4,5),txy(6,7)). 
rhs(out0_black0_7_1_10_5,sameR,s7691757,cxy(9,3),txy(7,5)). 
...
rhs(out0_silver1_5_1_5_1,sameR,sid_1x1,cxy(5,1),txy(5,1)). 
...
rhs(out0_silver1_9_1_9_1,sameR,sid_1x1,cxy(9,1),txy(9,1)). 
rhs(out0_silver1_10_5_10_5,sameR,sid_1x1,cxy(10,5),txy(10,5)). 
```
