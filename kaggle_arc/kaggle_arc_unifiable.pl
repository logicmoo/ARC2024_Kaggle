...
at_least_one_name_value_overlap(DSame,PSame):-
  member(DS,DSame),member(S,PSame),
  same_name_and_value(DS,S),!.
...
same_name_and_value(P,DP):- P=@=DP, !.
same_name_and_value(P,DP):- same_prop_names(P,DP), \+ other_val(P,DP).
